 ...
 */
@Component
public class DefaultKnowledgeGraphHolder implements KnowledgeBaseApiInternal._getKnowledgeBase,
    KnowledgeGraphHolder {

  private static final Logger logger = LoggerFactory.getLogger(DefaultKnowledgeGraphHolder.class);
   ...
   */
  public DefaultKnowledgeGraphHolder() {
   ...
   * @return a new {@link DefaultKnowledgeGraphHolder}
   */
  public static DefaultKnowledgeGraphHolder newKnowledgeGraphHolder(
  ...
  public static DefaultKnowledgeGraphHolder newKnowledgeGraphHolder(
    ...
    var kgh = new DefaultKnowledgeGraphHolder();
  ...
  @PreDestroy
  @Loggable(level = LogLevel.INFO)
  public void shutdownKnowledgeGraph() {
    try {
